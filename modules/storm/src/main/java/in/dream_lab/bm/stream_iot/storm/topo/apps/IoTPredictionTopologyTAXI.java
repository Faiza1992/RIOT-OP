...
public class IoTPredictionTopologyTAXI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String basePathForMultipleSpout="/home/amna/PycharmProjects/DataAnlytics1/Storm-Scheduler-SC-scripts/TAXI-inputcsv-predict-10spouts200mps-480sec-file/";

        System.out.println("basePathForMultipleSpout is used -"+basePathForMultipleSpout);

        String spout1InputFilePath="/home/amna/storm/riot-bench/modules/tasks/src/main/resources/TAXI_sample_data_senml.csv";
